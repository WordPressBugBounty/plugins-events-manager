	...
	<div  class="postbox " >
		...
		<div class="inside">
			...
			<table class='form-table'>
				...
				em_options_textarea( __( 'Event tooltips format', 'events-manager' ), 'dbem_emfc_qtips_format', __( 'If you enable tips, this information will be shown, which can include HTML.', 'events-manager' ) . ' ' . $events_placeholder_tip, '#_EVENTNAME' );
