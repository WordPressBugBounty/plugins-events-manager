				...
				<div  class="postbox " id="em-opt-ms-options" >
					...
					<div class="inside">
						<table class="form-table">
							...
							<?php
							global $current_site;
							$global_slug_tip   = __( '%1$s belonging to other sub-sites will have an extra slug prepended to it so that your main site can differentiate between its own %2$s and those belonging to other sites in your network.', 'events-manager' );
							$global_link_tip   = __( 'When displaying global %1$s on the main site you have the option of users viewing the %2$s details on the main site or being directed to the sub-site.', 'events-manager' );
							$global_post_tip   = __( 'Displays %1$s from all sites on the network by default. You can still restrict %2$s by blog using shortcodes and template tags coupled with the <code>blog</code> attribute. Requires global tables to be turned on.', 'events-manager' );
							$global_link_tip2  = __( 'You <strong>must</strong> have assigned a %1$s page in your <a href="%2$s">main blog settings</a> for this to work.', 'events-manager' );
							...
							?>
							<tr class="em-header"><td><h4><?php echo sprintf( __( '%s Options', 'events-manager' ), __( 'Event', 'events-manager' ) ); ?></h4></td></tr>
							<?php
							...
							?>
							<tr class="em-header"><td><h4><?php echo sprintf( __( '%s Options', 'events-manager' ), __( 'Location', 'events-manager' ) ); ?></h4></td></tr>
							<?php
