...
class Phone {
	...
	public static function init() {
		if ( static::is_enabled() ) {
			add_filter( 'em_booking_get_person_post', array( static::class, 'em_booking_get_person_post' ), 10, 3 );
			add_filter( 'em_registration_errors', array( static::class, 'em_registration_errors' ), 10, 4 );
		}
	}
