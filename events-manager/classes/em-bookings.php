...
class EM_Bookings extends EM_Object implements Iterator, ArrayAccess {
	...
	public static function get_sql_accepted_fields() {
		...
		$accepted_fields = array(
			...
			'orderby_user_data'    => array( 'user_email' ), // mapped further down, see comment above
			'orderby_user_meta'    => array( 'user_name', 'first_name', 'last_name', 'dbem_phone' ), // mapped further down, see comment above
			'orderby_booking_meta' => array(), // mapped further down, see comment above
		);
		...
		foreach ( array( 'orderby_user_meta', 'orderby_user_data', 'orderby_booking_meta' ) as $orderby_key ) {
	...
	public static function get_default_search( $array_or_defaults = array(), $array = array() ) {
		...
		$search_defaults = static::clean_id_atts( $search_defaults, array( 'booking_id' ) );
