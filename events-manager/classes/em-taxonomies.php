...
class Taxonomies {
	...
	public static function init() {
		...
		if ( $tags_enabled ) {
			static::$taxonomies['event-tags'] = array(
		...
		if ( $categories_enabled ) {
			static::$taxonomies['event-categories'] = array(
		...
		add_action( 'em_archetypes_register_post_types', array( static::class, 'register_taxonomies' ), 10, 2 );
	...
	public static function register_taxonomy( $taxonomy_type ) {
		...
		register_taxonomy( $taxonomy['taxonomy'], array(), $taxonomy );
	}
}
Taxonomies::init();
