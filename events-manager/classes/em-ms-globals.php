...
class EM_MS_Globals {
	...
	function get_globals() {
		$globals = array(
			// archetypes
			'dbem_ms_archetypes_enabled',
			'dbem_ms_archetypes_mode',
			'dbem_archetypes_rename_labels',
			'dbem_archetypes_rename_slugs',
			'dbem_archetypes_rename_cpts',
			//multisite settings
			...
			'dbem_ms_events_slug',
			'dbem_ms_global_locations',
			'dbem_ms_global_locations_links',
			'dbem_ms_locations_slug',
			...
			'dbem_image_max_size' . 'dbem_image_min_width',
			'dbem_image_min_height',
			// uploads
			'dbem_uploads_ui',
			'dbem_uploads_max_file_size',
			'dbem_uploads_max_files',
			'dbem_uploads_allow_multiple',
			'dbem_uploads_type',
