...
class PhoneNumberUtil {
	...
	+ array( self::PLUS_SIGN => self::PLUS_SIGN )
	+ array(
		'*' => '*',
		'#' => '#',
	);
	 ...
	 */
	protected const ALPHA_MAPPINGS = array(
		'A' => '2',
		'B' => '2',
		'C' => '2',
		'D' => '3',
	 ...
	 */
	protected const MOBILE_TOKEN_MAPPINGS = array(
		'54' => '9',
	);
	 ...
	 */
	protected const GEO_MOBILE_COUNTRIES_WITHOUT_MOBILE_AREA_CODES = array(
		86, // China
	);
	 ...
	 */
	protected const GEO_MOBILE_COUNTRIES = array(
		52, // Mexico
		54, // Argentina
		55, // Brazil
	 ...
	 */
	protected const ASCII_DIGIT_MAPPINGS = array(
		'0' => '0',
		'1' => '1',
		'2' => '2',
		'3' => '3',
	 ...
	 */
	protected const NUMERIC_CHARACTERS = array(
		"\xef\xbc\x90" => 0,
		"\xef\xbc\x91" => 1,
		"\xef\xbc\x92" => 2,
		"\xef\xbc\x93" => 3,
	 ...
	 * @var int[]
	 */
	protected array $countryCodesForNonGeographicalRegion = array();
	/**
	 * The set of regions the library supports.
	 *
	 * @var string[]
	 */
	protected array $supportedRegions = array();
	 ...
	 */
	protected array $countryCallingCodeToRegionCodeMap = array();
	/**
	 * The set of regions that share country calling code 1.
	 *
	 * @var string[]
	 */
	protected array $nanpaRegions = array();
