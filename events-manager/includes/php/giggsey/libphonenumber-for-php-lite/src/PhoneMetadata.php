...
class PhoneMetadata {
	 ...
	 * @var NumberFormat[]
	 */
	protected array $numberFormat                       = array();
	 ...
	 * @var NumberFormat[]
	 */
	protected array $intlNumberFormat = array();
	...
	public function fromArray( array $input ): PhoneMetadata {
		...
		foreach ( $input['numberFormat'] ?? array() as $numberFormatElt ) {
			$numberFormat = new NumberFormat();
			$numberFormat->fromArray( $numberFormatElt );
			$this->addNumberFormat( $numberFormat );
		}

		foreach ( $input['intlNumberFormat'] ?? array() as $intlNumberFormatElt ) {
			$numberFormat = new NumberFormat();
