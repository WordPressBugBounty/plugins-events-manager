...
<div class="em-search-geo-units em-search-field" 
<?php
if ( empty( $args['geo'] ) || empty( $args['near'] ) ) :
	?>
	...
	<select name="near_distance" class="em-search-geo-distance">
		...
		<option value="km" 
		<?php
		if ( $args['near_unit'] == 'km' ) {
			echo 'selected="selected"';}
		?>
		><?php esc_html_e( 'Kilometers', 'events-manager' ); ?></option>
	</select>
</div>
