...
$id = esc_attr( $args['id'] );
?>
<div class="<?php em_template_classes( 'search-advanced', 'search-advanced-inline' ); ?> <?php echo esc_attr( implode( ' ', $args['css_classes_advanced'] ) ); ?>" id="em-search-advanced-<?php echo $id; ?>" data-parent="em-search-form-<?php echo $id; ?>" data-view="<?php echo esc_attr( $args['view'] ); ?>" 
<?php
