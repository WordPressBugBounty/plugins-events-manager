		...
		<div class="em-search-views-options input" id="em-search-views-options-<?php echo $id; ?>">
			<fieldset class="em-search-views-options-list" id="em-search-views-options-select-<?php echo $id; ?>">
				...
				foreach ( $args['views'] as $view ) :
					$view_name = $search_views[ $view ]['name'];
					?>
					<label class="em-search-view-option em-search-view-type-<?php echo esc_attr( $view ); ?>
					<?php
					if ( $view === $args['view'] ) {
						echo 'checked';}
					?>
					"  data-view="<?php echo esc_attr( $view ); ?>">
						<input type="radio" name="view" class="em-search-view-option em-search-view-type-<?php echo esc_attr( $view ); ?>" value="<?php echo esc_attr( $view ); ?>"  
						<?php
						if ( $view === $args['view'] ) {
							echo 'checked';}
						?>
