...
<div class="<?php em_template_classes( 'view-container' ); ?>" id="em-view-<?php echo $id; ?>" data-view="event">
	...
	?>
	<form enctype='multipart/form-data' id="event-form-<?php echo $id; ?>" class="<?php em_template_classes( 'event-editor' ); ?>
	<?php
	...
	"
		...
		<section class="event-form-name <?php echo $template; ?>">
			...
			<div class="input">
				<input type="text" name="event_name" id="event-name" value="<?php echo esc_attr( $EM_Event->event_name ); ?>" placeholder="
				<?php
				esc_html_e( 'Event Name', 'events-manager' );
				echo ' *';
				?>
				">
