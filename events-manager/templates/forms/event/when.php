...
<div class="em event-form-when input" id="em-form-when">
			...
			<p class="em-event-type">
				<label data-nostyle>
					...
					<?php else : ?>
						...
						<input type="checkbox" id="em-recurrence-checkbox-<?php echo $id; ?>" class="em-recurrence-checkbox event_type" name="event_type" value="recurring" 
						<?php
	...
	<div class="em-event-datetimes single-event-data">
		...
		<?php endif; ?>
		<?php require em_locate_template( 'forms/event/when/times.php' ); ?>
		<?php require em_locate_template( 'forms/event/when/timezone.php' ); ?>
