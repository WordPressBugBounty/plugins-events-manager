...
<div class="em-recurrence-set-actions">
	...
	<?php
	if ( defined( 'EM_DEBUG' ) && EM_DEBUG && $Recurrence_Set->recurrence_set_id ) {
		echo '<span style="opacity:0.5; display: inline-block; float: left; margin: 10px 5px; font-size: 10px;">#' . $Recurrence_Set->id . '</span>';} // debugging help
	?>
</div>
<div class="em-recurrence-set-data">
	...
	<?php
	require em_locate_template( 'forms/event/when/recurring/recurrences/pattern.php' );
	require em_locate_template( 'forms/event/when/recurring/recurrences/advanced-summary.php' );
	?>
	<div class="em-recurrence-advanced">
		...
		require em_locate_template( 'forms/event/when/recurring/recurrences/times.php' );
		require em_locate_template( 'forms/event/when/recurring/recurrences/timezone.php' );
