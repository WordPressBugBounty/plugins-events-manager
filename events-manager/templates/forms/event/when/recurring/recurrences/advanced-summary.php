...
<div class="advanced-summary">
	<span class="dates">
		...
		<?php
		if ( $Recurrence_Set->recurrence_date_start ) {
			echo 'is-set';}
		?>
		"><?php echo $Recurrence_Set->start->format( em_get_datepicker_format() ); ?></span> -
		<span class="end-date 
		<?php
		if ( $Recurrence_Set->recurrence_date_end ) {
			echo 'is-set';}
		?>
		"><?php echo $Recurrence_Set->end->format( em_get_datepicker_format() ); ?></span>
	</span>
	...
	if ( $isset ) {
		echo 'is-set';}
	?>
	"><?php echo esc_html__( 'All day', 'events-manager' ); ?></span>

	(<span class="timezone 
	<?php
	if ( $Recurrence_Set->recurrence_timezone ) {
		echo 'is-set';}
	?>
	"><?php echo $Recurrence_Set->start->getTimezone()->getCity(); ?></span>)

	<span class="duration-days">|
		<span class="duration 
		<?php
		if ( $Recurrence_Set->recurrence_duration ) {
			echo 'is-set';}
		?>
		"><?php echo $Recurrence_Set->duration; ?></span>
