...
<div class="em-input-field em-input-field-text em-location-data-url input">
	...
	<input id="event_location_url" type="text" name="event_location_url" value="
	<?php
	if ( $EM_Event->has_event_location( 'url' ) ) {
		echo esc_attr( $EM_Event->get_event_location()->url );}
	?>
	" />
</div>
<div class="em-input-field em-input-field-text em-location-data-url-text input">
	...
	<input id="event_location_url_text" type="text" name="event_location_url_text" value="
	<?php
	if ( $EM_Event->has_event_location( 'url' ) ) {
		echo esc_attr( $EM_Event->get_event_location()->text );}
	?>
	" />
</div>